...
List Erlang_Malaria_Cut(
        ...
        // Population size
        NumericVector N_H = matrix(H_S + H_I + H_R) //human host population 
        NumericVector N_P = matrix(P_S + P_I) // p. vector population
        NumericVector N_S = matrix(S_S + S_I) // s. vector population
